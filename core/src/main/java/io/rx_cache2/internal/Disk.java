...
public final class Disk implements Persistence {
     ...
     * @param encryptKey  The key used to encrypt/decrypt the record to be persisted.
     */
    @Override public io.rx_cache2.internal.Record retrieveRecord(String key, boolean isEncrypted,
                                                                 String encryptKey) {
        key = safetyKey(key);
        ...
        try {
            ...
            Record diskRecord = jolyglot.fromJson(file.getAbsoluteFile(), Record.class);
